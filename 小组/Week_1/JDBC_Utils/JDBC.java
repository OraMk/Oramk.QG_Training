package The_First_week.Backgroup_First_work.JDBC_Utils;
...
public class JDBC {
    ...
    public JDBC() throws ClassNotFoundException, SQLException, IOException {
        //载入配置文件
        properties.load(new FileInputStream("D:\\QG_work\\src\\The_First_week\\Backgroup_First_work\\config.properties"));
        //获取配置文件中的数据
