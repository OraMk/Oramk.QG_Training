package The_First_week.Backgroup_First_work.HandWriting_JDBC;
...
public class MaintenanceConnection {
    ...
    public synchronized static void Initialize() throws Exception {
        ...
        properties.load(new FileInputStream("D:\\QG_work\\src\\The_First_week\\Backgroup_First_work\\HandWriting_JDBC\\config.properties"));
